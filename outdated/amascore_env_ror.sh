...
if [ "$yn" == "Y" -o "$yn" == "y" ]; then 
	...
	$aptexe install -y apache2 mysql-server php php-mysql php-mcrypt libapache2-mod-php
else
	echo "I don't know what is your choice...skipping this step" 
fi

echo "installing some tools..."
$aptexe install -y curl openssh-server
$aptexe install -y git-core zlib1g-dev build-essential libssl-dev libreadline-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev libcurl4-openssl-dev software-properties-common libffi-dev nodejs yarn
