...
sudo $aptexe install -y python3 python3-pip
wget http://scada.amastek.com/env/python.txt
pip3 install -r python.txt --user
...
#	echo "setup some extra libraries..."
#	cd ~
#	wget http://scada.amastek.com/env/lib/libmysqlclient.so
#	wget http://scada.amastek.com/env/lib/libcurl.so
#	wget http://scada.amastek.com/env/lib/libudev.so
#	sudo cp ./libmysqlclient.so /usr/lib/
#	sudo cp ./libcurl.so /usr/lib/
#	sudo cp ./libudev.so /usr/lib/
#	cd /usr/lib
#	sudo ln -s libmysqlclient.so libmysqlclient.so.18
#	sudo ln -s libcurl.so libcurl.so.4
